...
def modernizer_node(state: ModernizationState) -> ModernizationState:
    ...
    prompt = (
        ...
        "1. LOGIC PARITY: Preserve every single calculation, index, and mathematical operation.\n"
        "2. RAII: Use smart pointers (unique_ptr/shared_ptr), vectors, and file streams. Replace malloc/free/new/delete.\n"
        "3. CHRONO: Use std::chrono::system_clock and duration types. Avoid manual std::time_t manipulation if possible.\n"
        ...
        "8. EFFICIENCY: Use 'std::string_view' for read-only parameters.\n"
